// Utility 136: destination-alias-normalizer
// Small NearBell helper for arrival alerts and route status handling.

export function destinationAliasNormalizer(input = {}) {
  ...
  return {
    key: 'destination-alias-normalizer',
    etaMinutes,
    distanceMeters,
    closeEnough,
    minutesSinceAlert,
...
export default destinationAliasNormalizer;
